...
export default {
  ...
  mounted() {
    //在发请求之前带给服务器参数searchParams参数发生变化带给服务器
    this.getData();
  },
  ...
  watch: {
    ...
    $route(newValue, oldValue) {
      //每次请求完毕，应该把相应的1、2、3级分类的id置空，让他接受下一次的相应id
      //categoryName与keyword不用清理：因为每一次路由发生变化的时候，都会被赋予新的数据
